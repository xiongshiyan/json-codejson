...
public class JSONObjectTest {
    ...
    public void serialize() throws Exception {
        ...
        javaBean.setK1("11");
        javaBean.setK2("k2");
        javaBean.setBoolean1(Boolean.TRUE);
        javaBean.setBigInteger1(new BigInteger("12"));
        javaBean.setBigDecimal1(new BigDecimal("12.12"));
        String serialize = jsonObject.serialize(javaBean , true , "k1");
        Assert.assertEquals("{\"bigDecimal1\":12.12,\"bigInteger1\":12,\"bbbbbb\":true}" , serialize);
        Assert.assertTrue(new JSONObject(serialize).getBoolean("bbbbbb"));
    }
    ...
    public void testToString() throws Exception {
        ...
        map.put("bigInteger1",new BigInteger("1"));
        map.put("bigDecimal1",new BigDecimal("1"));
        ...
        System.out.println(JsonTool.write(map));
    }
